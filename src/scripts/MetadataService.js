...
export class MetadataService {
    ...
    async enrichAll(library, movies, apiKey) {
    ...
    async enrichLibrary(library, apiKey, progress, dispatchProgress) {
        const showNames = Object.keys(library);
        ...
        for (const showName of showNames) {
            ...
            try {
                ...
                const url = `${TMDB_BASE_URL}/search/tv` +
    ...
    async enrichMovies(movies, apiKey, progress, dispatchProgress) {
