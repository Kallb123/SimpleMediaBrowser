...
function CustomDrawerContent(props) {
    ...
    return (<DrawerContentScrollView {...props}>
      ...
      <DrawerItem label={editMode ? '✏️ Exit Edit Mode' : '✏️ Edit Mode'} onPress={handleEditModeToggle} labelStyle={editMode ? styles.editModeActiveLabel : undefined}/>

      {/* Password prompt modal */}
      <Modal visible={showPasswordModal} transparent animationType="fade" onRequestClose={cancelPassword}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <ThemedTextInput value={passwordInput} onChangeText={(v) => {
            setPasswordInput(v);
            setPasswordError('');
        }} placeholder="Password" secureTextEntry style={styles.modalInput} autoFocus onSubmitEditing={submitPassword}/>
...
export default function DrawerLayout() {
    ...
    return (<Drawer drawerContent={(props) => <CustomDrawerContent {...props}/>} screenOptions={{
            ...
            <Drawer.Screen name="tv" options={{
            drawerLabel: '📺 TV',
            title: "",
        }}/>
            <Drawer.Screen name="movies" options={{
            drawerLabel: '🎬 Movies',
            title: "",
        }}/>
            <Drawer.Screen name="settingsprompt" options={{
            ...
            <Drawer.Screen name="logs" options={{
